...
%\usepackage[margin=3.3 cm]{geometry}
...
\end{abstract}
\let\thefootnote\relax\footnote{2020 Mathematics Subject Classification: 53C25 (primary).

Keywords: $\spin(7)$ metric, cohomogeneity one metric.

The author is supported by the NSFC (No. 12301078), the Natural Science Foundation of Jiangsu Province (BK-20220282), and the XJTLU Research Development Funding (RDF-21-02-083).}
