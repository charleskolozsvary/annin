...
Right now the next thing I need to do is, though, is actually create those word (and actually also inline math, now that I think of it) rectangles and draw them and see if they're accurate.\footnote[9001]{I wonder if I can mark boxes inside of footnotes. Update: it looks like I can! Update two: I could, but I didn't seriously stop to consider if I should.}
\end{document}
