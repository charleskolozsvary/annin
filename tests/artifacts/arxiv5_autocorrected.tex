...
\end{equation}
Witten's $r$-spin conjecture states that $\frac{\partial F^{\frac{1}{r},c}}{\partial t^{r-1}_d}=0$ %%
%⭡⭡⭡ END of correction 29
for $d\geq 0$ (the \emph{Ramond vanishing phenomenon}) and that under the change of variables
...
\textit{stable graded $r$-spin disk or cylinder} ( \textit{legal stable graded $r$-spin disk or cylinder}, respectively) is %%
...
%% Comment:   ""
%%
%⭣⭣⭣ START of corrections 197, 198
$\Mbarstar_{1,k,l}^{1/r}$ and define 
\begin{equation*}
{\mathcal{W}}:= (R^0\pi_*\mathcal{J})_+
\end{equation*}
as a vector bundle over $\Mbarstar_{1,k,l}^{1/r}\setminus \mathcal Z^{dj}$%%
%⭡⭡⭡ END of corrections 197, 198
. 
...
%% Comment:   "])."
%%
%⭣⭣⭣ START of corrections 307, 316, 317
...
in \cite[Propositions 3.1 and 3.3]{TZ1}.
