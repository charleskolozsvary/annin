...
%⭡ ⭡ ⭡  END of annotation 1
%%
%% Annotation 2, page 1 (AUTOCORRECTED) [ ]
%% Caret: "work extends<Caret> a result of"
%% Comment: ""
%%
%% Annotation 3, page 1 (AUTOCORRECTED) [ ]
...
%% Annotation 13, page 1 [ ]
%% Caret: "t if π `` t2,<Caret> pu and gcdp"
%% Comment: ""
%%
%% Annotation 14, page 1 (AUTOCORRECTED) [ ]
%% Caret: "f π `` t2, pu<Caret> and gcdp|G|"
%% Comment: ""
%%
%% Annotation 15, page 1 (AUTOCORRECTED) [ ]
%% Caret: "|G|, 2pq {\k a} 1<Caret>, then G pos"
%% Comment: ""
%%
%% Annotation 16, page 1 (AUTOCORRECTED) [ ]
%% Caret: "G|, 2pq {\k a} 1,<Caret> then G poss"
%% Comment: ""
%%
%% Annotation 17, page 1 (AUTOCORRECTED) [ ]
%% Caret: " {\k a} 1, then G<Caret> possesses a"
%% Comment: ""
%%
%% Annotation 18, page 1 (AUTOCORRECTED) [ ]
%% Caret: "pq {\k a} 1, then<Caret> G possesses"
%% Comment: ""
%%
%% Annotation 19, page 1 (AUTOCORRECTED) [ ]
%% Caret: "in Qpe2πi{pq<Caret>. (Here, a c"
%% Comment: ""
%%
%% Annotation 20, page 1 (AUTOCORRECTED) [ ]
%% Caret: "n Qpe2πi{pq.<Caret> (Here, a ch"
%% Comment: ""
%%
%% Annotation 21, page 1 [ ]
...
%⭡ ⭡ ⭡  END of annotations 13, 14, 15, 16, 17, 18, 19, 20, 21
$\pi$.)
...
%% Annotation 26, page 1 (AUTOCORRECTED) [ ]
%% Caret: " of t3, 5u1-<Caret>degree with "
%% Comment: ""
%%
%% Annotation 27, page 1 (AUTOCORRECTED) [ ]
...
if $\pi(H)\subseteq \pi$
and $|G:H|$ is %%
%⭡ ⭡ ⭡  END of annotations 22, 23, 24, 25
...
%% Annotation 31, page 2 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 35, page 2 (AUTOCORRECTED) [ ]
...
%% Annotation 40, page 3 (AUTOCORRECTED) [ ]
%% Caret: " a tp1, p2u-<Caret>Hall subgrou"
%% Comment: ""
%%
%% Annotation 41, page 3 (AUTOCORRECTED) [ ]
%% Caret: "s a tp1, p2u<Caret>-Hall subgro"
%% Comment: ""
%%
%% Annotation 42, page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 43, page 3 [ ]
%% Caret: "2 P tp1, p2u<Caret> {\v D} π. This c"
%% Comment: ""
%%
%% Annotation 44, page 3 [ ]
...
that $H$ is also a %%
%% Annotation 45, page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 46, page 3 [ ]
%% Caret: "oup 2F4p2q1.<Caret>  Proof The "
%% Comment: ""
%%
%% Annotation 47, page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 66, page 3 (AUTOCORRECTED) [ ]
...
Hall %%
%% Annotation 65, page 3 [ ]
%% Caret: "-subgroup. □<Caret>  R k 2 4 Th"
%% Comment: ""
%%
%% Annotation 67, page 3 (AUTOCORRECTED) [ ]
%% Caret: "l π-subgroup<Caret>. □  Remark "
%% Comment: ""
%%
%% Annotation 68, page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 55, page 3 (AUTOCORRECTED) [ ]
...
a fixed %%
%% Annotation 57, page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 52, page 3 (AUTOCORRECTED) [ ]
%% Caret: "smaller than<Caret> p. In this "
%% Comment: ""
%%
%% Annotation 58, page 3 [ ]
%% Caret: "aller than p<Caret>. In this ca"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
smaller than $p$. In %%
%⭡ ⭡ ⭡  END of annotations 52, 58
...
satisfy $\chi(1)=p$. %%
%% Annotation 51, page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 49, page 3 [ ]
%% Caret: " ppp´3q  2 ,<Caret> by [Ras77]."
%% Comment: ""
%%
%% Annotation 50, page 3 [ ]
...
%% Annotation 76, page 4 [ ]
%% Caret: "and T :`` TF;<Caret> see [Car85,"
%% Comment: ""
%%
%% Annotation 77, page 4 (AUTOCORRECTED) [ ]
%% Caret: " and T :`` TF<Caret>; see [Car85"
%% Comment: ""
%%
%% Annotation 78, page 4 (AUTOCORRECTED) [ ]
...
where $U:=\bU^F$ and
$T:=\bT^F$; see %%
%⭡ ⭡ ⭡  END of annotations 76, 77, 78
\cite[\S1.9 and \S2.9]{Carter85}.

Let $(\bG^*,F^*)$ be the pair dual to $(\bG,F)$, and %%
%% Annotation 74, page 4 (AUTOCORRECTED) [ ]
%% Caret: "G˚ :`` G˚F ˚.<Caret> Note that S"
%% Comment: ""
%%
%% Annotation 75, page 4 (AUTOCORRECTED) [ ]
...
$\bB^*$ be an %%
%% Annotation 73, page 4 (AUTOCORRECTED) [ ]
...
subgroup of $\bG^*$ %%
%% Annotation 71, page 4 (AUTOCORRECTED) [ ]
...
%% Annotation 80, page 5 [ ]
%% Caret: "CG˚psqq|ℓ1 ``<Caret> |π´1pCG˚psq"
%% Comment: ""
%%
%% Annotation 81, page 5 [ ]
%% Caret: "C rGprsq|ℓ1.<Caret>  "
%% Comment: ""
%%
%% Annotation 82, page 5 [ ]
%% Caret: "´1pCG˚psqq :<Caret> C rGprsq|ℓ1"
%% Comment: ""
%%
%% Annotation 83, page 5 [ ]
...
%% Annotation 84, page 6 (AUTOCORRECTED) [ ]
...
First, %%
%⭡ ⭡ ⭡  END of annotation 84
it %%
%% Annotation 85, page 6 (AUTOCORRECTED) [ ]
%% Caret: " it is clear<Caret> that |Impκq"
%% Comment: ""
%%
%% Annotation 86, page 6 [ ]
%% Caret: "at |Impκq| |<Caret> pq ´ ϵq. No"
%% Comment: ""
%%
%% Annotation 87, page 6 (AUTOCORRECTED) [ ]
...
%% Annotation 88, page 6 (AUTOCORRECTED) [ ]
%% Caret: "t statement.<Caret>  Le a 2 10 "
%% Comment: ""
%%
%% Annotation 89, page 6 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 90, page 6 [ ]
%% Caret: "`` pq ´ 1qn´1<Caret>,  so p divi"
%% Comment: ""
%%
%% Annotation 91, page 6 [ ]
...
\]
so %%
%⭡ ⭡ ⭡  END of annotations 90, 91
$p$ divides $q-1$. In the unitary %%
%% Annotation 92, page 6 (AUTOCORRECTED) [ ]
%% Caret: " if n is eve<Caret>n,  "
%% Comment: ""
%%
%% Annotation 93, page 6 [ ]
...
%% Annotation 97, page 7 [ ]
%% Caret: "1 n´2˘ P rG.<Caret>  Let s deno"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
element
...
%%
%% Annotation 98, page 7 (AUTOCORRECTED) [ ]
%% Caret: " π : rG Ñ G˚<Caret>. Then  ordp"
%% Comment: ""
%%
%% Annotation 99, page 7 (AUTOCORRECTED) [ ]
%% Caret: "G Ñ G˚. Then<Caret>  ordpsq `` o"
%% Comment: ""
%%
%% Annotation 100, page 7 [ ]
...
Note %%
%⭡ ⭡ ⭡  END of annotations 101, 102, 103
...
%% Annotation 141, page 7 (AUTOCORRECTED) [ ]
%% Caret: "2.10, it fol<Caret>lows that CG"
%% Comment: ""
%%
%% Annotation 142, page 7 (AUTOCORRECTED) [ ]
%% Caret: " 2.10, it fo<Caret>llows that C"
%% Comment: ""
%%
%% Annotation 143, page 7 (AUTOCORRECTED) [ ]
...
it follows
that %%
%⭡ ⭡ ⭡  END of annotations 141, 142, 143
...
%% Annotation 105, page 7 [ ]
%% Caret: " ˚ {d'} CG˚psq.<Caret>  It follows"
%% Comment: ""
%%
%% Annotation 106, page 7 (AUTOCORRECTED) [ ]
%% Caret: " |G˚ : T ˚|,<Caret> and hence  "
%% Comment: ""
%%
%% Annotation 107, page 7 (AUTOCORRECTED) [ ]
%% Caret: "follows that<Caret> |G˚ : CG˚ps"
%% Comment: ""
%%
%% Annotation 108, page 7 (AUTOCORRECTED) [ ]
%% Caret: ".  It follow<Caret>s that |G˚ :"
%% Comment: ""
%%
%% Annotation 109, page 7 (AUTOCORRECTED) [ ]
%% Caret: "  It follows<Caret> that |G˚ : "
%% Comment: ""
%%
%% Annotation 110, page 7 (AUTOCORRECTED) [ ]
%% Caret: "˚psq.  It fo<Caret>llows that |"
%% Comment: ""
%%
%% Annotation 111, page 7 (AUTOCORRECTED) [ ]
%% Caret: "psq.  It fol<Caret>lows that |G"
%% Comment: ""
%%
%% Annotation 112, page 7 (AUTOCORRECTED) [ ]
%% Caret: " T ˚|, and h<Caret>ence χsp1q ``"
%% Comment: ""
%%
%% Annotation 113, page 7 (AUTOCORRECTED) [ ]
%% Caret: "T ˚|, and he<Caret>nce χsp1q `` "
%% Comment: ""
%%
%% Annotation 114, page 7 (AUTOCORRECTED) [ ]
%% Caret: " ˚|, and hen<Caret>ce χsp1q `` |"
%% Comment: ""
%%
%% Annotation 115, page 7 (AUTOCORRECTED) [ ]
%% Caret: "˚|, and henc<Caret>e χsp1q `` |G"
%% Comment: ""
%%
%% Annotation 116, page 7 (AUTOCORRECTED) [ ]
%% Caret: "|, and hence<Caret> χsp1q `` |G˚"
%% Comment: ""
%%
%% Annotation 117, page 7 (AUTOCORRECTED) [ ]
%% Caret: " : T ˚|, and<Caret> hence χsp1q"
%% Comment: ""
%%
%% Annotation 118, page 7 (AUTOCORRECTED) [ ]
%% Caret: "˚ : T ˚|, an<Caret>d hence χsp1"
%% Comment: ""
%%
%% Annotation 119, page 7 (AUTOCORRECTED) [ ]
%% Caret: "G˚ : T ˚|, a<Caret>nd hence χsp"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
have \[T^*\le
...
\]
As %%
%⭡ ⭡ ⭡  END of annotations 105, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 116, 117, 118, 119
$|G^*:T^*|_{\ell'}=|G^*:B^*|$ is a $\pi'$-number %%
%% Annotation 140, page 7 (AUTOCORRECTED) [ ]
...
%% Annotation 120, page 7 [ ]
%% Caret: "trivial on Z<Caret>pGq. This co"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
on $\bZ({G})$. %%
%⭡ ⭡ ⭡  END of annotation 120
This completes the proof
for linear %%
%% Annotation 121, page 7 (AUTOCORRECTED) [ ]
%% Caret: "ar groups. I<Caret>t remains to"
%% Comment: ""
%%
%% Annotation 122, page 7 (AUTOCORRECTED) [ ]
%% Caret: "groups. It r<Caret>emains to co"
%% Comment: ""
%%
%% Annotation 123, page 7 (AUTOCORRECTED) [ ]
%% Caret: "oups. It rem<Caret>ains to cons"
%% Comment: ""
%%
%% Annotation 124, page 7 (AUTOCORRECTED) [ ]
%% Caret: "roups. It re<Caret>mains to con"
%% Comment: ""
%%
%% Annotation 125, page 7 (AUTOCORRECTED) [ ]
%% Caret: "ups. It rema<Caret>ins to consi"
%% Comment: ""
%%
%% Annotation 126, page 7 (AUTOCORRECTED) [ ]
%% Caret: "s. It remain<Caret>s to conside"
%% Comment: ""
%%
%% Annotation 127, page 7 (AUTOCORRECTED) [ ]
%% Caret: "It remains t<Caret>o consider t"
%% Comment: ""
%%
%% Annotation 128, page 7 (AUTOCORRECTED) [ ]
%% Caret: "emains to co<Caret>nsider the c"
%% Comment: ""
%%
%% Annotation 129, page 7 (AUTOCORRECTED) [ ]
%% Caret: "remains to c<Caret>onsider the "
%% Comment: ""
%%
%% Annotation 130, page 7 (AUTOCORRECTED) [ ]
%% Caret: "mains to con<Caret>sider the ca"
%% Comment: ""
%%
%% Annotation 131, page 7 (AUTOCORRECTED) [ ]
%% Caret: "ns to consid<Caret>er the case "
%% Comment: ""
%%
%% Annotation 132, page 7 (AUTOCORRECTED) [ ]
%% Caret: "ns to consid<Caret>er the case "
%% Comment: ""
%%
%% Annotation 133, page 7 (AUTOCORRECTED) [ ]
%% Caret: "ins to consi<Caret>der the case"
%% Comment: ""
%%
%% Annotation 134, page 7 (AUTOCORRECTED) [ ]
%% Caret: "ains to cons<Caret>ider the cas"
%% Comment: ""
%%
%% Annotation 135, page 7 (AUTOCORRECTED) [ ]
%% Caret: "s to conside<Caret>r the case ϵ"
%% Comment: ""
%%
%% Annotation 136, page 7 (AUTOCORRECTED) [ ]
%% Caret: "o consider t<Caret>he case ϵ `` "
%% Comment: ""
%%
%% Annotation 137, page 7 (AUTOCORRECTED) [ ]
%% Caret: "consider the<Caret> case ϵ `` ´1"
%% Comment: ""
%%
%% Annotation 138, page 7 (AUTOCORRECTED) [ ]
%% Caret: " consider th<Caret>e case ϵ `` ´"
%% Comment: ""
%%
%% Annotation 139, page 7 (AUTOCORRECTED) [ ]
...
%⭡ ⭡ ⭡  END of annotations 121, 122, 123, 124, 125, 126, 127, 128, 129, 130, 131, 132, 133, 134, 135, 136, 137, 138, 139
and $p \mid (q-1)$.
...
%% Annotation 144, page 7 [ ]
%% Caret: "er pq2´1qn{2<Caret>  if n is ev"
%% Comment: ""
%%
%% Annotation 145, page 7 (AUTOCORRECTED) [ ]
%% Caret: "f n is even.<Caret>  "
%% Comment: ""
%%
%% Annotation 146, page 7 (AUTOCORRECTED) [ ]
...
Note %%
%⭡ ⭡ ⭡  END of annotations 144, 145, 146
...
%% Annotation 153, page 8 (AUTOCORRECTED) [ ]
%% Caret: "ement s P G˚<Caret> such that  "
%% Comment: ""
%%
%% Annotation 154, page 8 [ ]
%% Caret: "lement s P G<Caret>˚ such that "
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
element $s\in G^*$ such %%
%⭡ ⭡ ⭡  END of annotations 153, 154
%%
%% Annotation 152, page 8 (AUTOCORRECTED) [ ]
...
Here, %%
%% Annotation 157, page 8 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 148, page 8 (AUTOCORRECTED) [ ]
%% Caret: "ith ϵ P t˘1u<Caret>, where ϵ `` "
%% Comment: ""
%%
%% Annotation 149, page 8 (AUTOCORRECTED) [ ]
%% Caret: "th ϵ P t˘1u,<Caret> where ϵ `` 1"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
$\epsilon\in\{\pm1\}$, where %%
%⭡ ⭡ ⭡  END of annotations 148, 149
%%
%% Annotation 150, page 8 (AUTOCORRECTED) [ ]
...
%% Annotation 158, page 8 [ ]
%% Caret: "s and ϵ `` ´1<Caret> to the twis"
%% Comment: ""
%%
%% Annotation 159, page 8 [ ]
...
fact that %%
%% Annotation 155, page 8 [ ]
%% Caret: "that s P T ˚<Caret>, as argued "
%% Comment: ""
%%
%% Annotation 156, page 8 [ ]
%% Caret: "hat s P T ˚,<Caret> as argued i"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
$s\in T^*$, as %%
%⭡ ⭡ ⭡  END of annotations 155, 156
...
some
$\alpha\in\Irr(\bZ(G))$. %%
%% Annotation 182, page 9 (AUTOCORRECTED) [ ]
%% Caret: "1qαq `` αχp1q<Caret>, which impl"
%% Comment: ""
%%
%% Annotation 183, page 9 [ ]
...
%%
%% Annotation 178, page 9 (AUTOCORRECTED) [ ]
%% Caret: "{N is a Hall<Caret> π-subgroup "
%% Comment: ""
%%
%% Annotation 179, page 9 (AUTOCORRECTED) [ ]
%% Caret: " is a Hall π<Caret>-subgroup of"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
a Hall $\pi$-subgroup of %%
%⭡ ⭡ ⭡  END of annotations 178, 179
$G/N$.


Another fact we need is that %%
%% Annotation 175, page 9 (AUTOCORRECTED) [ ]
...
%% Annotation 169, page 9 (AUTOCORRECTED) [ ]
...
\Irr(G)$ lie over $\psi$. %%
%% Annotation 165, page 9 [ ]
%% Caret: " `` {\v r}r i``1 ψi<Caret> is the sum "
%% Comment: ""
%%
%% Annotation 166, page 9 [ ]
%% Caret: "er χM `` ψ or<Caret> χM `` {\v r}r i``1"
%% Comment: ""
%%
%% Annotation 167, page 9 [ ]
%% Caret: "ither χM `` ψ<Caret> or χM `` {\v r}r "
%% Comment: ""
%%
%% Annotation 168, page 9 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 162, page 9 [ ]
%% Caret: "p1q is a π1-<Caret> number and "
%% Comment: ""
%%
%% Annotation 163, page 9 [ ]
%% Caret: "p1q is a π1-<Caret> number and "
%% Comment: ""
%%
%% Annotation 164, page 9 [ ]
%% Caret: "rψp1q is a π<Caret>1- number an"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
a $\pi'$-number and %%
%⭡ ⭡ ⭡  END of annotations 162, 163, 164
$\QQ(\chi) \subseteq
...
%%
%% Annotation 193, page 10 (AUTOCORRECTED) [ ]
...
\,N. Hung, %%
%% Annotation 184, page 10 (AUTOCORRECTED) [ ]
%% Caret: " A. Schaeffe<Caret>r Fry, and C"
%% Comment: ""
%%
%% Annotation 185, page 10 (AUTOCORRECTED) [ ]
%% Caret: "A. A. Schaef<Caret>fer Fry, and"
%% Comment: ""
%%
%% Annotation 186, page 10 (AUTOCORRECTED) [ ]
%% Caret: "A. A. Schaef<Caret>fer Fry, and"
%% Comment: ""
%%
%% Annotation 187, page 10 (AUTOCORRECTED) [ ]
%% Caret: "A. A. Schaef<Caret>fer Fry, and"
%% Comment: ""
%%
%% Annotation 188, page 10 (AUTOCORRECTED) [ ]
%% Caret: " A. A. Schae<Caret>ffer Fry, an"
%% Comment: ""
%%
%% Annotation 189, page 10 (AUTOCORRECTED) [ ]
%% Caret: ", A. A. Scha<Caret>effer Fry, a"
%% Comment: ""
%%
%% Annotation 190, page 10 (AUTOCORRECTED) [ ]
%% Caret: "g, A. A. Sch<Caret>aeffer Fry, "
%% Comment: ""
%%
%% Annotation 191, page 10 (AUTOCORRECTED) [ ]
%% Caret: "ng, A. A. Sc<Caret>haeffer Fry,"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
A.\,A. Schaeffer Fry, %%
%⭡ ⭡ ⭡  END of annotations 184, 185, 186, 187, 188, 189, 190, 191
and %%
%% Annotation 192, page 10 (AUTOCORRECTED) [ ]
