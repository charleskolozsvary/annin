...
\begin{abstract}
%%
%% Annotation 2, 2/30 on page 1 (AUTOCORRECTED) [ ]
...
%⭡ ⭡ ⭡  END of annotation 2
%%
%% Annotation 3, 3/30 on page 1 (AUTOCORRECTED) [ ]
%% Caret: "work extends<Caret> a result of"
%% Comment: ""
%%
%% Annotation 4, 4/30 on page 1 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 6, 6/30 on page 1 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 15, 15/30 on page 1 (AUTOCORRECTED) [ ]
%% Caret: "f π `` t2, pu<Caret> and gcdp|G|"
%% Comment: ""
%%
%% Annotation 16, 16/30 on page 1 (AUTOCORRECTED) [ ]
%% Caret: "|G|, 2pq {\k a} 1<Caret>, then G pos"
%% Comment: ""
%%
%% Annotation 17, 17/30 on page 1 (AUTOCORRECTED) [ ]
%% Caret: "G|, 2pq {\k a} 1,<Caret> then G poss"
%% Comment: ""
%%
%% Annotation 18, 18/30 on page 1 (AUTOCORRECTED) [ ]
%% Caret: " {\k a} 1, then G<Caret> possesses a"
%% Comment: ""
%%
%% Annotation 19, 19/30 on page 1 (AUTOCORRECTED) [ ]
%% Caret: "pq {\k a} 1, then<Caret> G possesses"
%% Comment: ""
%%
%% Annotation 20, 20/30 on page 1 (AUTOCORRECTED) [ ]
%% Caret: "in Qpe2πi{pq<Caret>. (Here, a c"
%% Comment: ""
%%
%% Annotation 21, 21/30 on page 1 (AUTOCORRECTED) [ ]
...
%% Annotation 27, 27/30 on page 1 (AUTOCORRECTED) [ ]
%% Caret: " of t3, 5u1-<Caret>degree with "
%% Comment: ""
%%
%% Annotation 28, 28/30 on page 1 (AUTOCORRECTED) [ ]
...
G$ is called %%
%% Annotation 29, 29/30 on page 1 (AUTOCORRECTED) [ ]
%% Caret: "alled a Hall<Caret> π-subgroup "
%% Comment: ""
%%
%% Annotation 30, 30/30 on page 1 (AUTOCORRECTED) [ ]
...
%% Annotation 32, 2/10 on page 2 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 36, 6/10 on page 2 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 39, 9/10 on page 2 (AUTOCORRECTED) [ ]
%% Caret: "rticular let<Caret> π `` tp1, p2"
%% Comment: ""
%%
%% Annotation 40, 10/10 on page 2 (AUTOCORRECTED) [ ]
...
%% Annotation 41, 1/30 on page 3 (AUTOCORRECTED) [ ]
%% Caret: " a tp1, p2u-<Caret>Hall subgrou"
%% Comment: ""
%%
%% Annotation 42, 2/30 on page 3 (AUTOCORRECTED) [ ]
%% Caret: "s a tp1, p2u<Caret>-Hall subgro"
%% Comment: ""
%%
%% Annotation 43, 3/30 on page 3 (AUTOCORRECTED) [ ]
...
that $H$ is also a %%
%% Annotation 46, 6/30 on page 3 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 48, 8/30 on page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 67, 27/30 on page 3 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 68, 28/30 on page 3 (AUTOCORRECTED) [ ]
%% Caret: "l π-subgroup<Caret>. □  Remark "
%% Comment: ""
%%
%% Annotation 69, 29/30 on page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 56, 16/30 on page 3 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 54, 14/30 on page 3 (AUTOCORRECTED) [ ]
%% Caret: "racter. This<Caret> observation"
%% Comment: ""
%%
%% Annotation 57, 17/30 on page 3 (AUTOCORRECTED) [ ]
...
a fixed %%
%% Annotation 58, 18/30 on page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 53, 13/30 on page 3 (AUTOCORRECTED) [ ]
...
satisfy $\chi(1)=p$. %%
%% Annotation 52, 12/30 on page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 60, 20/30 on page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 61, 21/30 on page 3 (AUTOCORRECTED) [ ]
%% Caret: "{ZpGq, where<Caret> G :`` GF is "
%% Comment: ""
%%
%% Annotation 62, 22/30 on page 3 (AUTOCORRECTED) [ ]
%% Caret: "here G :`` GF<Caret> is the grou"
%% Comment: ""
%%
%% Annotation 63, 23/30 on page 3 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 64, 24/30 on page 3 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 78, 8/9 on page 4 (AUTOCORRECTED) [ ]
%% Caret: " and T :`` TF<Caret>; see [Car85"
%% Comment: ""
%%
%% Annotation 79, 9/9 on page 4 (AUTOCORRECTED) [ ]
...
%% Annotation 75, 5/9 on page 4 (AUTOCORRECTED) [ ]
%% Caret: "G˚ :`` G˚F ˚.<Caret> Note that S"
%% Comment: ""
%%
%% Annotation 76, 6/9 on page 4 (AUTOCORRECTED) [ ]
...
$\bB^*$ be an %%
%% Annotation 74, 4/9 on page 4 (AUTOCORRECTED) [ ]
...
subgroup of $\bG^*$ %%
%% Annotation 72, 2/9 on page 4 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 95, 11/13 on page 6 (AUTOCORRECTED) [ ]
%% Caret: "psqq Ñ Z def<Caret>ined by grsg"
%% Comment: ""
%%
%% Annotation 96, 12/13 on page 6 (AUTOCORRECTED) [ ]
%% Caret: "psqq Ñ Z def<Caret>ined by grsg"
%% Comment: ""
%%
%% Annotation 97, 13/13 on page 6 (AUTOCORRECTED) [ ]
...
%% Annotation 85, 1/13 on page 6 (AUTOCORRECTED) [ ]
...
it %%
%% Annotation 86, 2/13 on page 6 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 88, 4/13 on page 6 (AUTOCORRECTED) [ ]
...
%% Annotation 89, 5/13 on page 6 (AUTOCORRECTED) [ ]
%% Caret: "t statement.<Caret>  Le a 2 10 "
%% Comment: ""
%%
%% Annotation 90, 6/13 on page 6 (AUTOCORRECTED) [ ]
...
%% Annotation 93, 9/13 on page 6 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 99, 2/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: " π : rG Ñ G˚<Caret>. Then  ordp"
%% Comment: ""
%%
%% Annotation 100, 3/50 on page 7 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 103, 6/50 on page 7 (AUTOCORRECTED) [ ]
...
%% Annotation 142, 45/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "2.10, it fol<Caret>lows that CG"
%% Comment: ""
%%
%% Annotation 143, 46/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: " 2.10, it fo<Caret>llows that C"
%% Comment: ""
%%
%% Annotation 144, 47/50 on page 7 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 107, 10/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: " |G˚ : T ˚|,<Caret> and hence  "
%% Comment: ""
%%
%% Annotation 108, 11/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "follows that<Caret>  |G˚ : CG˚p"
%% Comment: ""
%%
%% Annotation 109, 12/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: ".  It follow<Caret>s that  |G˚ "
%% Comment: ""
%%
%% Annotation 110, 13/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "  It follows<Caret> that  |G˚ :"
%% Comment: ""
%%
%% Annotation 111, 14/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "˚psq.  It fo<Caret>llows that  "
%% Comment: ""
%%
%% Annotation 112, 15/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "psq.  It fol<Caret>lows that  |"
%% Comment: ""
%%
%% Annotation 113, 16/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: " T ˚|, and h<Caret>ence  χsp1q "
%% Comment: ""
%%
%% Annotation 114, 17/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "T ˚|, and he<Caret>nce  χsp1q ``"
%% Comment: ""
%%
%% Annotation 115, 18/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: " ˚|, and hen<Caret>ce  χsp1q `` "
%% Comment: ""
%%
%% Annotation 116, 19/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "˚|, and henc<Caret>e  χsp1q `` |"
%% Comment: ""
%%
%% Annotation 117, 20/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "|, and hence<Caret>  χsp1q `` |G"
%% Comment: ""
%%
%% Annotation 118, 21/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: " : T ˚|, and<Caret> hence  χsp1"
%% Comment: ""
%%
%% Annotation 119, 22/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "˚ : T ˚|, an<Caret>d hence  χsp"
%% Comment: ""
%%
%% Annotation 120, 23/50 on page 7 (AUTOCORRECTED) [ ]
...
%% Annotation 141, 44/50 on page 7 (AUTOCORRECTED) [ ]
...
for linear %%
%% Annotation 122, 25/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "r groups.  I<Caret>t remains to"
%% Comment: ""
%%
%% Annotation 123, 26/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "roups.  It r<Caret>emains to co"
%% Comment: ""
%%
%% Annotation 124, 27/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "ups.  It rem<Caret>ains to cons"
%% Comment: ""
%%
%% Annotation 125, 28/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "oups.  It re<Caret>mains to con"
%% Comment: ""
%%
%% Annotation 126, 29/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "ps.  It rema<Caret>ins to consi"
%% Comment: ""
%%
%% Annotation 127, 30/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: ".  It remain<Caret>s to conside"
%% Comment: ""
%%
%% Annotation 128, 31/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "It remains t<Caret>o consider t"
%% Comment: ""
%%
%% Annotation 129, 32/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "emains to co<Caret>nsider the c"
%% Comment: ""
%%
%% Annotation 130, 33/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "remains to c<Caret>onsider the "
%% Comment: ""
%%
%% Annotation 131, 34/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "mains to con<Caret>sider the ca"
%% Comment: ""
%%
%% Annotation 132, 35/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "ns to consid<Caret>er the case "
%% Comment: ""
%%
%% Annotation 133, 36/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "ns to consid<Caret>er the case "
%% Comment: ""
%%
%% Annotation 134, 37/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "ins to consi<Caret>der the case"
%% Comment: ""
%%
%% Annotation 135, 38/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "ains to cons<Caret>ider the cas"
%% Comment: ""
%%
%% Annotation 136, 39/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "s to conside<Caret>r the case ϵ"
%% Comment: ""
%%
%% Annotation 137, 40/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "o consider t<Caret>he case ϵ `` "
%% Comment: ""
%%
%% Annotation 138, 41/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "consider the<Caret> case ϵ `` ´1"
%% Comment: ""
%%
%% Annotation 139, 42/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: " consider th<Caret>e case ϵ `` ´"
%% Comment: ""
%%
%% Annotation 140, 43/50 on page 7 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 146, 49/50 on page 7 (AUTOCORRECTED) [ ]
%% Caret: "f n is even.<Caret>  "
%% Comment: ""
%%
%% Annotation 147, 50/50 on page 7 (AUTOCORRECTED) [ ]
...
%% Annotation 154, 7/14 on page 8 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 153, 6/14 on page 8 (AUTOCORRECTED) [ ]
...
Here, %%
%% Annotation 158, 11/14 on page 8 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 149, 2/14 on page 8 (AUTOCORRECTED) [ ]
%% Caret: "ith ϵ P t˘1u<Caret>, where ϵ `` "
%% Comment: ""
%%
%% Annotation 150, 3/14 on page 8 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 151, 4/14 on page 8 (AUTOCORRECTED) [ ]
...
some
$\alpha\in\Irr(\bZ(G))$. %%
%% Annotation 183, 22/23 on page 9 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 179, 18/23 on page 9 (AUTOCORRECTED) [ ]
%% Caret: "{N is a Hall<Caret> π-subgroup "
%% Comment: ""
%%
%% Annotation 180, 19/23 on page 9 (AUTOCORRECTED) [ ]
...
%% Annotation 176, 15/23 on page 9 (AUTOCORRECTED) [ ]
...
%% Annotation 170, 9/23 on page 9 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 169, 8/23 on page 9 (AUTOCORRECTED) [ ]
...
%%
%% Annotation 194, 10/10 on page 10 (AUTOCORRECTED) [ ]
...
\,N. Hung, %%
%% Annotation 185, 1/10 on page 10 (AUTOCORRECTED) [ ]
%% Caret: " A. Schaeffe<Caret>r Fry, and C"
%% Comment: ""
%%
%% Annotation 186, 2/10 on page 10 (AUTOCORRECTED) [ ]
%% Caret: "A. A. Schaef<Caret>fer Fry, and"
%% Comment: ""
%%
%% Annotation 187, 3/10 on page 10 (AUTOCORRECTED) [ ]
%% Caret: "A. A. Schaef<Caret>fer Fry, and"
%% Comment: ""
%%
%% Annotation 188, 4/10 on page 10 (AUTOCORRECTED) [ ]
%% Caret: "A. A. Schaef<Caret>fer Fry, and"
%% Comment: ""
%%
%% Annotation 189, 5/10 on page 10 (AUTOCORRECTED) [ ]
%% Caret: " A. A. Schae<Caret>ffer Fry, an"
%% Comment: ""
%%
%% Annotation 190, 6/10 on page 10 (AUTOCORRECTED) [ ]
%% Caret: ", A. A. Scha<Caret>effer Fry, a"
%% Comment: ""
%%
%% Annotation 191, 7/10 on page 10 (AUTOCORRECTED) [ ]
%% Caret: "g, A. A. Sch<Caret>aeffer Fry, "
%% Comment: ""
%%
%% Annotation 192, 8/10 on page 10 (AUTOCORRECTED) [ ]
...
and %%
%% Annotation 193, 9/10 on page 10 (AUTOCORRECTED) [ ]
