...
%% Annotation 7, 7/7 on page 1 (AUTOCORRECTED) [ ]
...
form 
\begin{equation*}
\bA(\by)\bx  \approx \bb =  \bb_{\rm true} + \mathbf{\epsilon} \quad \mbox{ with\quad } \bA( \by_{\rm true}) \bx_{\rm true} = \bb_{\rm true},
\end{equation*}
where %%
%⭡ ⭡ ⭡  END of annotation 7
...
%% Annotation 8, 1/2 on page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 9, 2/2 on page 3 (AUTOCORRECTED) [ ]
...
%% Annotation 11, 2/2 on page 5 (AUTOCORRECTED) [ ]
