...
%% Annotation 20, page 6 [ ]
%% Caret: " =  j=0 U(j)<Caret> where U(j) "
%% Comment: ","
%%
%⭣ ⭣ ⭣ 
of minima of %%
...
We define the %%
%% Annotation 21, page 6 [ ]
%% Caret: " max i,x∗νx∗<Caret> i  "
%% Comment: "."
%%
%% Annotation 22, page 6 [ ]
%% Circle: "None, annot.type = <Circle>"
%% Comment: "."
%%
%⭣ ⭣ ⭣ 
...
%% Annotation 26, page 10 [ ]
%% PolyLine: "n=0 um,ntne−λ(m,h)t<SEL>/h</SEL>  m∈U(0)         u(t) − X  <SEL>     </SEL>  <SEL>≤Ce</SEL>−εhc−1t ∥u0∥,"
%% Comment: "break"
%%
%⭣ ⭣ ⭣ 
satisfies
...
%% PolyLine: "∥e−f/h∥2 e−2f/h <SEL>      TV ≤</SEL>Ce −t"
%% Comment: "break"
%%
%⭣ ⭣ ⭣ 
...
%% Annotation 43, page 23 [ ]
%% Ink: "Rd Σk,iΣn<SEL>,ivkvne−2|v|2/hdv</SEL>  k,n  Z  2 det(Σ−1) X  = 4δi,j(CΣh)−d  Rd v2 k<SEL>e−2|v|2/hdv</SEL>  k Σ2 k,i  Z  2 det(Σ−1) X  = 4δi,j(CΣh)−d  Rd e<SEL>−2|v|2/hdv</SEL>  k Σ2"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
Then
...
%% Annotation 45, page 24 [ ]
%% Ink: "k1,k2,k3,k4 Σk1,iΣk2,iΣk3,jΣk<SEL>4,jvk1vk2vk3vk4e−2|v|2/hdv</SEL>  X  2 det(Σ−1) Z  = 4(CΣh)−d  Rd  k̸=n Σ2 k,iΣ2 n,jv2 kv2 ne−2|v|2/hd<SEL>v</SEL>  2 det(Σ−1) Z  + 4(CΣh)−d  Rd 2 X  k̸=n Σk,iΣn,i<SEL>Σk,jΣn,jv2 kv2 ne−2|v|2/hdv</SEL>  X  2 det(Σ−1) Z  + 4(CΣh)−d  Rd  k Σ2 k,iΣ2 k,jv<SEL>4 ke−2|v|2/hdv</SEL>  h2  "
%% Comment: ""
%%
%% Annotation 46, page 24 [ ]
%% Ink: "None, annot.type = <Ink>"
%% Comment: ""
%%
%% Annotation 47, page 24 [ ]
%% Text: "None, annot.type = <Text>"
%% Comment: "adjust to fit"
%%
%⭣ ⭣ ⭣ 
...
%% Annotation 49, page 29 [ ]
%% FreeText: "dx  Z  <SEL>adju st to  fit</SEL>  3 X"
%% Comment: "adjust to fit"
%%
%⭣ ⭣ ⭣ 
obtain
...
%% Annotation 61, page 57 (AUTOCORRECTED) [ ]
%% Delete: "a non<SEL>-</SEL> separating saddle"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
a nonseparating saddle %%
...
%% Annotation 62, page 59 [ ]
%% Highlight: "V G <SEL>dV )−1/2u, (h2−</SEL>2  ν"
...
%% Annotation 65, page 60 [ ]
%% Highlight: "u    = <SEL>⟨G−1G1/2 dV (h2−2  ν g1(h) + d∗ V G dV )−1/2u, G1/2 dV (h2−2  ν g1(h) + d∗ V G dV )</SEL>−1/2u⟩  ≤"
...
%% Annotation 64, page 60 [ ]
%% Highlight: "d∗ V,i     <SEL>+ Ch   dV,j R1/2     R1/2 d∗ V G1/2     G1/2 dV R1/2     R1/</SEL>2    <SEL>+ 2Ch   dV,j R1/2     R1/2 d∗ V G1/2     G1/2   ∥R∥.</SEL>  "
%% Comment: "shift left"
%%
%⭣ ⭣ ⭣ 
have
...
%% Annotation 66, page 61 [ ]
%% Line: "dV,j R <SEL>   ≲</SEL>h 2"
%% Comment: "break"
%%
%⭣ ⭣ ⭣ 
obtain
...
%% Annotation 70, page 64 (AUTOCORRECTED) [ ]
...
%% Annotation 84, page 66 (AUTOCORRECTED) [ ]
%% Replace: "Operator Theory<SEL>, 96</SEL> (2024). [17]"
%% Comment: " \textbf{96} "
%%
%⭣ ⭣ ⭣ 
Operator Theory \textbf{96}  (2024). %%
...
%% Annotation 82, page 66 (AUTOCORRECTED) [ ]
%% Delete: "9 (2008), <SEL>pp.</SEL> 209--274. [18]"
%% Comment: ""
%%
%% Annotation 83, page 66 (AUTOCORRECTED) [ ]
%% Replace: "Henri Poincar´e<SEL>, 9</SEL> (2008), pp."
%% Comment: " \textbf{9} "
%%
%⭣ ⭣ ⭣ 
Poincar\'e \textbf{9}  (2008), ~209--274. %%
%⭡ ⭡ ⭡  END of annotations 82, 83

\bibitem{HeHiSj11_01}
\bysame, {\em Tunnel effect and symmetries for {K}ramers-{F}okker-{P}lanck type operators}, J. Inst. Math. %%
%% Annotation 77, page 66 (AUTOCORRECTED) [ ]
%% Replace: "Math. Jussieu, <SEL>10</SEL> (2011), pp."
%% Comment: "\textbf{10}"
%%
%% Annotation 81, page 66 (AUTOCORRECTED) [ ]
%% Delete: "10 (2011), <SEL>pp.</SEL> 567--634. [19]"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
Jussieu, \textbf{10} (2011), ~567--634. %%
%⭡ ⭡ ⭡  END of annotations 77, 81
...
%% Annotation 78, page 66 (AUTOCORRECTED) [ ]
%% Replace: "Mech. Anal., <SEL>171</SEL> (2004), pp."
%% Comment: "\textbf{171}"
%%
%% Annotation 79, page 66 (AUTOCORRECTED) [ ]
%% Delete: "Mech. Anal.<SEL>,</SEL> 171 (2004),"
%% Comment: ""
%%
%% Annotation 80, page 66 (AUTOCORRECTED) [ ]
%% Delete: "171 (2004), <SEL>pp.</SEL> 151--218.  "
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
Mech. Anal. \textbf{171} (2004), ~151--218. %%
%⭡ ⭡ ⭡  END of annotations 78, 79, 80
