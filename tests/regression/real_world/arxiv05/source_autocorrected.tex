...
%% Comment: ""
%%
%% Annotation 6, page 1 (AUTOCORRECTED) [ ]
...
%⭡ ⭡ ⭡  END of annotations 1, 2, 3, 4, 5, 6
...
%% Annotation 7, page 1 [ ]
%% Caret: " in [31, 32]<Caret>. We prove t"
%% Comment: ""
%%
%% Annotation 12, page 1 [ ]
%% Caret: "developed in<Caret> [31, 32]. W"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
potential equals, after a %%
%⭡ ⭡ ⭡  END of annotations 7, 12
...
%% Comment: ""
%%
%% Annotation 15, page 2 [ ]
%% Caret: "s conjecture<Caret> [33], prove"
%% Comment: ""
%%
%% Annotation 16, page 2 (AUTOCORRECTED) [ ]
...
%⭡ ⭡ ⭡  END of annotations 13, 14, 15, 16
...
%% Annotation 20, page 2 (AUTOCORRECTED) [ ]
...
%% Annotation 17, page 2 (AUTOCORRECTED) [ ]
%% Caret: " theory. Let<Caret> ψ1, . . . ,"
%% Comment: ""
%%
%% Annotation 18, page 2 [ ]
...
%% Annotation 19, page 2 [ ]
%% Caret: " · · · ψdn n<Caret>  d1,...,dn≥"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
by
...
%% Annotation 24, page 2 (AUTOCORRECTED) [ ]
%% Caret: "marked curve<Caret> (C; z1, . ."
%% Comment: ""
%%
%% Annotation 25, page 2 (AUTOCORRECTED) [ ]
...
%% Annotation 23, page 2 [ ]
%% Caret: "  i=1 ai[zi]<Caret>  "
%% Comment: ""
%%
%% Annotation 26, page 2 [ ]
%% Caret: "<Caret> ai ∈{0, 1, "
%% Comment: ""
%%
%% Annotation 27, page 2 [ ]
...
%% Annotation 33, page 2 (AUTOCORRECTED) [ ]
%% Caret: "itten bundle<Caret> (R1π∗S)∨, w"
%% Comment: ""
%%
%% Annotation 34, page 2 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 36, page 2 (AUTOCORRECTED) [ ]
%% Caret: ",{a1,...,an}<Caret> is the univ"
%% Comment: ""
%%
%% Annotation 37, page 2 (AUTOCORRECTED) [ ]
...
%% Annotation 43, page 2 (AUTOCORRECTED) [ ]
%% Caret: "14, 10]. The<Caret> (closed) r-"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
...
%%
%% Annotation 44, page 2 (AUTOCORRECTED) [ ]
%% Caret: "osed) r-spin<Caret> intersectio"
%% Comment: ""
%%
%% Annotation 45, page 2 (AUTOCORRECTED) [ ]
...
%% Annotation 46, page 2 [ ]
%% Caret: ",c g := r1−g<Caret> Z  ⟨τ a1 d1"
%% Comment: ""
%%
%% Annotation 47, page 2 (AUTOCORRECTED) [ ]
...
%% Annotation 48, page 3 (AUTOCORRECTED) [ ]
%% Caret: "tion numbers<Caret>  ⟨a1 a ⟩  F"
%% Comment: ""
%%
%% Annotation 49, page 3 (AUTOCORRECTED) [ ]
%% Caret: "losed r-spin<Caret> intersectio"
%% Comment: ""
%%
%% Annotation 50, page 3 [ ]
%% Caret: " · · tan dn,<Caret>  n! ⟨τ a1 d"
%% Comment: ""
%%
...
%% Annotation 72, page 3 (AUTOCORRECTED) [ ]
...
%% Comment: ""
%%
%% Annotation 70, page 3 (AUTOCORRECTED) [ ]
...
%% Caret: " states that<Caret> ∂F 1 r ,c  "
%% Comment: ""
%%
...
%% Comment: ""
%%
%% Annotation 79, page 4 [ ]
%% Caret: "−1 d = 0 for<Caret> d ≥0 (the R"
%% Comment: ""
%%
%% Annotation 80, page 4 (AUTOCORRECTED) [ ]
%% Caret: "= 0 for d ≥0<Caret> (the Ramond"
%% Comment: ""
%%
%% Annotation 81, page 4 (AUTOCORRECTED) [ ]
%% Caret: "or d ≥0 (the<Caret> Ramond  van"
%% Comment: ""
%%
%% Annotation 82, page 4 (AUTOCORRECTED) [ ]
%% Caret: "d  vanishing<Caret> phenomenon)"
%% Comment: ""
%%
%% Annotation 83, page 4 (AUTOCORRECTED) [ ]
...
%⭡ ⭡ ⭡  END of annotations 77, 78, 79, 80, 81, 82, 83
that under the change of %%
%% Annotation 84, page 4 [ ]
%% Caret: " 3k 2(r+1)−1<Caret>  (−r)  2 −d"
%% Comment: ""
%%
%% Annotation 85, page 4 (AUTOCORRECTED) [ ]
%% Caret: "2 dk!r where<Caret> k = a + 1 +"
%% Comment: ""
%%
%% Annotation 86, page 4 [ ]
...
\end{gather}
where $k=a+1+rd$ and %%
%⭡ ⭡ ⭡  END of annotations 84, 85, 86
$$
k!_r:=\prod_{i=0}^d(a+1+ri),
$$
%%
%% Annotation 87, page 4 (AUTOCORRECTED) [ ]
%% Caret: "i=0 it holds<Caret> that  res L"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
it holds that %%
...
%% Annotation 96, page 4 (AUTOCORRECTED) [ ]
...
%% Annotation 97, page 4 (AUTOCORRECTED) [ ]
...
%% Annotation 90, page 4 (AUTOCORRECTED) [ ]
...
data is %%
%% Annotation 91, page 4 (AUTOCORRECTED) [ ]
...
%% Annotation 114, page 5 (AUTOCORRECTED) [ ]
%% Caret: " be found in<Caret> [12]. There"
%% Comment: ""
%%
%% Annotation 115, page 5 (AUTOCORRECTED) [ ]
%% Caret: "ound in [12]<Caret>. There were"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
...
%% Annotation 101, page 5 (AUTOCORRECTED) [ ]
%% Caret: "e defined by<Caret>    l !  "
%% Comment: ""
%%
%% Annotation 102, page 5 (AUTOCORRECTED) [ ]
%% Caret: " are defined<Caret> by    l !  "
%% Comment: ""
%%
%% Annotation 103, page 5 (AUTOCORRECTED) [ ]
%% Caret: "tion numbers<Caret> are defined"
%% Comment: ""
%%
%% Annotation 104, page 5 [ ]
%% Caret: "W ⊕  ,  1 r <Caret>,o 0 := Z  ("
%% Comment: ""
%%
%% Annotation 105, page 5 [ ]
%% Caret: "  1 r ,o 0 :<Caret>= Z  (1.5) ⟨"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
...
%% Annotation 124, page 6 (AUTOCORRECTED) [ ]
%% Caret: "zero only if<Caret>  l 2Pl a + "
%% Comment: ""
%%
%% Annotation 125, page 6 (AUTOCORRECTED) [ ]
%% Caret: "<Caret> particular,"
%% Comment: ""
%%
%% Annotation 126, page 6 (AUTOCORRECTED) [ ]
%% Caret: "=1 r  In par<Caret>ticular,  l "
%% Comment: ""
%%
%% Annotation 127, page 6 (AUTOCORRECTED) [ ]
...
%% Annotation 133, page 6 (AUTOCORRECTED) [ ]
%% Caret: "[32] defined<Caret> ⌊r  2⌋open "
%% Comment: ""
%%
%% Annotation 134, page 6 [ ]
...
%% Annotation 143, page 6 [ ]
%% Caret: "n−1(Ln/r)+Φ,<Caret> n ≥1, (1.9)"
%% Comment: ""
%%
%% Annotation 144, page 6 [ ]
%% Caret: "∂Tn = λn−1(L<Caret>n/r)+Φ, n ≥1"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
equations
...
%% Annotation 147, page 8 (AUTOCORRECTED) [ ]
...
%% Annotation 145, page 8 [ ]
%% Caret: ",...,l}  0 =<Caret>  0  0 +  "
%% Comment: ""
%%
%% Annotation 146, page 8 [ ]
%% Caret: "R τ ai di σk<Caret> + 1  S⊔R={2"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
Then
...
\end{align*}
\item[(b)] (Internal %%
%⭡ ⭡ ⭡  END of annotations 145, 146
marked point $g=0$ TRR) Suppose $l\geq 2$.  %%
%% Annotation 151, page 9 [ ]
%% Caret: ",...,l}  0 =<Caret>  0  0 +  "
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
...
$1$ %%
%% Annotation 152, page 9 [ ]
%% Caret: "*  + 1  *  =<Caret> X  τ r−2−a "
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
TRR)
...
String)
Assume $2g-2+k+2l>0$ %%
%% Annotation 153, page 9 [ ]
%% Caret: " σk + 1  g =<Caret>  g  "
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
then
...
\item[(e)](Open Dilaton)
Assume $2g-2+k+2l>0$, %%
%% Annotation 154, page 9 [ ]
%% Caret: " σk + 1  g =<Caret> (g + l + k "
%% Comment: ""
%%
%% Annotation 156, page 9 [ ]
%% Caret: "1 τ ai di σk<Caret> + 1  g = (g"
%% Comment: ""
%%
%⭣ ⭣ ⭣ 
then
...
\end{itemize}
The %%
%⭡ ⭡ ⭡  END of annotations 154, 156
first two equations were proven %%
%% Annotation 155, page 9 (AUTOCORRECTED) [ ]
