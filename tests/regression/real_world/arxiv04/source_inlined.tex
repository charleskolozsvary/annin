...
\begin{theorem}[Lurie] \label{lurie theorem} Suppose that $(\mathsf C,\mathsf W)$ underlies a combinatorial monoidal model category, which satisfies either: (a) all objects %%
...
%%
%⭣ ⭣ ⭣ 
, under ``reasonable hypotheses''  on $(\mathsf C,\mathsf W)$? 
