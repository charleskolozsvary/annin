...
The annotations are displayed in the panel on the right, and when you click on one its corresponding pair of images appears (and the box is highlighted). You can also set the status and checkmark of the annotation like in Adobe Acrobat by either clicking the status dropdown or checkmark box.
